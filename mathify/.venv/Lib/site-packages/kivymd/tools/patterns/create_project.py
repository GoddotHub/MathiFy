...
.. seealso::
    ...
    `MVC pattern <https://en.wikipedia.org/wiki/Model–view–controllers>`_
...
class {name_screen}Controller:
    """
    The `{name_screen}Controller` class represents a controllers implementation.
    Coordinates work of the view with the model.
    The controllers implements the strategy pattern. The controllers connects to
    the view to control its actions.
    """

    def __init__(self, model):
        self.model = model  # Model.{module_name}.{name_screen}Model
        self.view = {name_view}(controllers=self, model=self.model)
...
class BaseScreenView(MDScreen, Observer):
    ...
    controllers = ObjectProperty()
    """
    Controller object - :class:`~Controller.controller_screen.ClassScreenControler`.

    :attr:`controllers` is an :class:`~kivy.properties.ObjectProperty`
...
class {}(MDApp):
    ...
    def build_app(self) -> MDScreenManager:
        ...
        for i, name_screen in enumerate(screens.keys()):
            ...
            controllers = screens[name_screen]["controllers"](model)
            view = controllers.get_view()
...
https://en.wikipedia.org/wiki/Model–view–controllers
"""
{}
from kivymd.app import MDApp
from kivymd.uix.screenmanager import MDScreenManager
