...
When the controllers needs to select a node, it calls :meth:`select_node` and
...
class CompoundSelectionBehavior(object):
    ...
    def goto_node(self, key, last_node, last_node_idx):
        '''(internal) Used by the controllers to get the node at the position
    ...
    def select_node(self, node):
        ...
        It is called by the controllers when it selects a node and can be
    ...
    def deselect_node(self, node):
        ...
        It is called by the controllers when it deselects a node and can also
